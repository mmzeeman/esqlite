...
sqlite_version_test() ->
    ...
    ?assertEqual({row, {<<"3.24.0">>}}, esqlite3:step(Stmt)),
    ok.
...
sqlite_source_id_test() ->
    ...
    ?assertEqual({row, {<<"2018-06-04 19:24:41 c7ee0833225bfd8c5ec2f9bf62b97c4e04d03bd9566366d5221ac8fb199a87ca">>}}, esqlite3:step(Stmt)),
    ok.
